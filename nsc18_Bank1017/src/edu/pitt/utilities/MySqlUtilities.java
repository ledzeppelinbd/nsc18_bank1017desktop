...
public class MySqlUtilities implements DbUtilities {
	...
	/** The db name. */
	private String dbName = "nsc18_bank1017"; // default database name

	/** The db user name. */
	private String dbUserName = "nsc18"; // login name for the database server

	/** The db password. */
	private String dbPassword = "3564923"; // password for the database server
	...
	/* (non-Javadoc)
	 * @see edu.pitt.utilities.DbUtilities#connectionClose()
	 */
